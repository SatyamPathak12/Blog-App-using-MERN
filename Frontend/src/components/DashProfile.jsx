...
export default function DashProfile() {
  ...
  const uploadImage = async () => {
    ...
    setImageFileUploadError(null); // Reset the error before starting upload
    ...
    uploadTask.on(
      ...
      () => {
        getDownloadURL(uploadTask.snapshot.ref)
          ...
          .catch(() => {
            setImageFileUploadError('Error retrieving file URL.');
          });
      }
    );
  };
  ...
  return (
    <div className='max-w-lg mx-auto p-3 w-full'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        >
          {/* Show the progress bar only if there is no error and upload is ongoing */}
      ...
      <Modal.Body>
        <div className='text-center'>
          ...
          <h3 className='mb-5 text-lg text-gray-500 dark: text-gray-350'>Are you sure you want to delete your account</h3>
